...
def update_output_container(input_year, select_statistics):
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        ['Advertising_Expenditure'].mean().reset_index()
        R_chart3 = dcc.Graph(
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
         Unemployment_rate = recession_data.groupby('Vehicle_Type')['Automobile_Sales','Unemployment_Rate'].mean().reset_index()
        R_chart4  = dcc.Graph(
